...
import { FaHeart, FaShoppingCart, FaDoorOpen, FaUser } from 'react-icons/fa'; // Import the user icon
      ...
      <div className="navbar">
        ...
        <div className="icons">
          ...
          <div className="icon" onClick={handleProfileClick}>
            <FaUser /> {/* React Icon for profile icon */}
          </div>
          <div className="icon" onClick={handleLogout}>
            <FaDoorOpen /> {/* React Icon for logout icon */}
          </div>
        </div>
      </div>
